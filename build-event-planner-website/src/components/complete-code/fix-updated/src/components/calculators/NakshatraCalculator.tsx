...
export default function NakshatraCalculator({ isOpen, onClose }: { isOpen: boolean; onClose: () => void; }) {
      ...
      <div className="relative h-[32vh] md:h-[40vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white mb-3 tracking-tight drop-shadow-xl animate-slideInUp">
            {lang === 'hi' ? 'नक्षत्र कैल्कुलेटर' : 'Nakshatra Calculator'}
          </h1>
        ...
        <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl border border-white/10 p-8">
          {!result ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center"><button type="submit" className="bg-linear-to-r from-purple-500 to-gray-500 hover:from-purple-600 hover:to-gray-600 text-white font-black py-4 px-8 rounded-xl transition-all shadow-xl hover:shadow-purple-500/30 text-lg">{lang === 'hi' ? 'नक्षत्र खोजें' : 'Find Nakshatra'}</button></div>
            </form>
          ) : (
            <div className="text-center">
              <div className="bg-gray-700/50 rounded-xl p-8 mb-6">
                ...
                <p className="text-gray-300">{lang === 'hi' ? 'यह आपका जन्म नक्षत्र है' : 'This is your birth Nakshatra'}</p>
              </div>
